...
import ru.mipt.bit.platformer.game.graphic_contracts.Level;

import java.util.HashMap;
import java.util.Map;

import static ru.mipt.bit.platformer.game.gdx.util.GdxGameUtils.getSingleLayer;
import static ru.mipt.bit.platformer.game.gdx.util.GdxGameUtils.moveRectangleAtTileCenter;
