...
public class CommandPublisher {
    ...
    private void pushCommandsToQueue(GameEntity gameEntity, Collection<InputInstruction> userInstructions) {
        Set<QueueElement> commandsFromInstructions = userInstructions.stream()
                .map(instruction -> {
                    ...
                    return new QueueElement(gameEntity, command, CommandType.getType(instruction));
                })
    ...
    public static CommandPublisher initCommandPublisher(CommandQueue commandQueue, Renderers renderers) {
