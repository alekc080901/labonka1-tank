...
import static ru.mipt.bit.platformer.game.gdx.util.GdxGameUtils.createBoundingRectangle;
import static ru.mipt.bit.platformer.game.gdx.util.GdxGameUtils.drawTextureRegionUnscaled;
